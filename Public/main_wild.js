...
var HomeSelect = function(t) {
	...
	return a.createGameScene = function() {
		...
		t.x = 65, t.y = 0, t.rotation = -12, Tool.center(t), this.addChild(t);
		var e = Tool.createBitmapByName("home_left_png");
		e.x = 80, e.y = 24, Tool.center(e), e.touchEnabled = !0, this.addChild(e), e.addEventListener(egret.TouchEvent.TOUCH_TAP, function() {
			this.moneyIndex--, this.money && this.removeChild(this.money), this.moneyIndex < 0 && (this.moneyIndex = 2), this.money = Tool.createBitmapByName("home_" + this.nowMoney[this.moneyIndex] + "_png"), Tool.center(this.money), this.money.x = 165, this.money.y = 40, this.addChild(this.money), Mode.payMoney = Number(this.nowMoney[this.moneyIndex]), egret.log(Mode.payMoney)
		}, this);
		var i = Tool.createBitmapByName("home_right_png");
		i.x = 220, i.y = 11, Tool.center(i), i.touchEnabled = !0, this.addChild(i), i.addEventListener(egret.TouchEvent.TOUCH_TAP, function() {
			this.moneyIndex++, this.money && this.removeChild(this.money), this.moneyIndex > 2 && (this.moneyIndex = 0), this.money = Tool.createBitmapByName("home_" + this.nowMoney[this.moneyIndex] + "_png"), Tool.center(this.money), this.money.x = 165, this.money.y = 40, this.addChild(this.money), Mode.payMoney = Number(this.nowMoney[this.moneyIndex]), egret.log(Mode.payMoney)
		}, this);
		var a = Tool.createBitmapByName("home_box1_png");
		a.x = 376, a.y = 0, a.touchEnabled = !0, this.addChild(a), a.addEventListener(egret.TouchEvent.TOUCH_TAP, this.switchType, this), this.money = Tool.createBitmapByName("home_10000_png"), Tool.center(this.money), this.money.x = 165, this.money.y = 40, this.addChild(this.money), this.type = Tool.createBitmapByName("home_up_png"), this.type.x = 455, this.type.y = 18, this.addChild(this.type)
	}, a.switchType = function() {
		return "rise" == Mode.payType ? (Mode.payType = "fall", this.type && this.removeChild(this.type), this.type = Tool.createBitmapByName("home_down_png"), this.type.x = 455, this.type.y = 18, void this.addChild(this.type)) : "fall" == Mode.payType ? (Mode.payType = "rise", this.type && this.removeChild(this.type), this.type = Tool.createBitmapByName("home_up_png"), this.type.x = 455, this.type.y = 18, void this.addChild(this.type)) : void 0
	}, e
}(egret.Sprite);
...
var Home = function(t) {
	...
	return a.createGameScene = function() {
		...
		if(egret.log("data" + i.data.user_info.balance), Mode.money = Number(i.data.user_info.balance), Mode.talk = i.data.user_info.motto, Mode.xuanzerole = i.data.user_info.role, WndManager.root.selfName = i.data.user_info.nickname, null != i.data.open_prize && (Mode.PK_result = i.data.open_prize.pk.result, Mode.PK_money = i.data.open_prize.pk.money, null != i.data.open_prize.bet && (Mode.goumai_result = i.data.open_prize.bet.result, Mode.goumai_money = i.data.open_prize.bet.money)), 1 == i.data.user_info.bet_status ? Mode.payState = !0 : Mode.payState = !1, Mode.security = [], Mode.security.push(i.data.stock_trend.exponent), Mode.security.push(i.data.stock_trend.increase), Mode.security.push(i.data.stock_trend.percent), this.updateHead(), 1 == i.status) {
			...
			a.y = 445, this.addChild(a), Mode.payState ? (this.payBtn = Tool.createBitmapByName("home_dengdai_png"), this.payBtn.x = 237, this.payBtn.y = 518, this.addChild(this.payBtn)) : (this.payBtn = Tool.createBitmapByName("home_mairu_png"), this.payBtn.x = 237, this.payBtn.y = 518, this.payBtn.touchEnabled = !0, this.payBtn.name = "payBtn", this.addChild(this.payBtn), this.payBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.swichClick, this));
			var n = Tool.createBitmapByName("home_sc_png");
			n.pixelHitTest = !0, n.touchEnabled = !0, n.name = "sc", n.x = 367, n.y = 830, this.addChild(n), n.addEventListener(egret.TouchEvent.TOUCH_TAP, this.swichClick, this);
			var s = Tool.createBitmapByName("home_cfzx_png");
			s.pixelHitTest = !0, s.touchEnabled = !0, s.name = "cfzx", s.x = 276, s.y = 721, this.addChild(s), s.addEventListener(egret.TouchEvent.TOUCH_TAP, this.swichClick, this);
			var h = Tool.createBitmapByName("home_cj_png");
			h.pixelHitTest = !0, h.touchEnabled = !0, h.name = "cj", h.x = 200, h.y = 740, this.addChild(h), h.addEventListener(egret.TouchEvent.TOUCH_TAP, this.swichClick, this);
			var o = Tool.createBitmapByName("home_rank_png");
			o.pixelHitTest = !0, o.touchEnabled = !0, o.name = "ph", o.x = 93, o.y = 830, this.addChild(o), o.addEventListener(egret.TouchEvent.TOUCH_TAP, this.swichClick, this);
			var r = Tool.createBitmapByName("home_pk_png");
			r.pixelHitTest = !0, r.touchEnabled = !0, r.name = "pk", r.x = 220, r.y = 750, this.addChild(r), r.addEventListener(egret.TouchEvent.TOUCH_TAP, this.swichClick, this);
		}
...
var Shopxq = function(t) {
	...
	return a.createGameScene = function() {
		...
		var e = JSON.parse(t.target.data);
		this.shuarr = e.data.length, RES.getResByUrl("http://uat.zwmedia.com.cn" + e.data.ware_details.image, this.onImgload, this, RES.ResourceItem.TYPE_IMAGE), this.RQtxt = new egret.Sprite, this.addChild(this.RQtxt), this.gameinn = Tool.createTextFiled(250, 720, 250, 50, e.data.ware_details.price + "金币", 60, 16760598, !0), this.addChild(this.gameinn), this.gameinn.strokeColor = 4788754, this.gameinn.stroke = 6, this.pkwin = Tool.createTextFiled(0, 0, 500, 50, "商品名称：" + e.data.ware_details.title, 28, 5053713, !0), this.RQtxt.addChild(this.pkwin), this.gamewin = Tool.createTextFiled(0, 80, 500, 150, "使用规则：" + e.data.ware_details.rule, 28, 5053713, !0), this.RQtxt.addChild(this.gamewin), this.tuodong = new egret.ScrollView(this.RQtxt), this.tuodong.width = 640, this.tuodong.height = 150, this.tuodong.x = 80, this.tuodong.y = 455, this.tuodong.bounces = !0, this.addChild(this.tuodong), this.maxwin = Tool.createTextFiled(0, 40, 500, 50, "有效期：" + e.data.ware_details.expiry_date, 28, 5053713, !0), this.RQtxt.addChild(this.maxwin)
	}, a.onImgload = function(t) {
		var e = t,
			i = new egret.Sprite,
			a = new egret.Bitmap(e);
